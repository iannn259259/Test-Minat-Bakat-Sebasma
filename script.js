...
function showFieldDesc(field){
    let desc="";
    if(field==="Ekonomi"){
        desc = `💼 Pekerjaan: Akuntan\nDeskripsi: Akuntan mencatat, mengelola, menganalisis data keuangan.\nKisaran Gaji: Rp5.000.000 – Rp30.000.000 sesuai pengalaman\nRekomendasi Kampus: UI, UGM, UNAIR, UNDIP, UB`;
    }
    else if(field==="Sastra Inggris"){
        desc = `💼 Pekerjaan: Penulis / Editor / Penerjemah\nDeskripsi: Membuat karya tulis kreatif, menyunting, menerjemahkan teks\nKisaran Gaji: Rp4.000.000 – Rp25.000.000\nRekomendasi Kampus: UI, UNPAD, UNDIP`;
    }
    else if(field==="Biologi"){
        desc = `💼 Pekerjaan: Ahli Bioteknologi / Peneliti Lingkungan / Ahli Gizi\nDeskripsi: Meneliti organisme, menganalisis dampak manusia terhadap alam, memberi saran nutrisi\nKisaran Gaji: Rp5.000.000 – Rp30.000.000\nRekomendasi Kampus: UGM, IPB, ITB`;
    }
    else if(field==="Sosiologi"){
        desc = `💼 Pekerjaan: Peneliti Sosial / Konsultan Komunitas / Dosen Sosiologi\nDeskripsi: Menganalisis perilaku masyarakat, mengembangkan program sosial, mengajar bidang sosial budaya\nKisaran Gaji: Rp4.500.000 – Rp30.000.000\nRekomendasi Kampus: UI, UNPAD, UNAIR`;
    }
